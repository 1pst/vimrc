...
syn keyword	cSysFunc		ftrylockfile
syn keyword	cSysFunc		funlockfile
"""added by fred for kernel
syn keyword	cSysFunc		likely unlikely
syn keyword	cSysFunc		owner
syn keyword	cSysFunc		ioctl
syn keyword	cSysFunc		open
syn keyword	cSysFunc		llseek
syn keyword	cSysFunc		mmap
syn keyword	cSysFunc		poll
syn keyword	cSysFunc		release
syn keyword	cSysFunc		aio_read aio_write
syn keyword	cSysFunc		printk
syn keyword	cSysFunc		MKDEV MAJOR MINOR
syn keyword	cSysFunc		THIS_MODULE
syn keyword	cSysFunc		jiffies
syn keyword	cSysFunc		register_chrdev_region unregister_chrdev_region register_chrdev unregister_chrdev alloc_chrdev_region
syn keyword	cSysFunc		get_page free_page
syn keyword	cSysFunc		kmalloc kzalloc kfree
syn keyword	cSysFunc		kobject_set_name
syn keyword	cSysFunc		container_of
syn keyword	cSysFunc		cdev_init cdev_add cdev_del
syn keyword	cSysFunc		imajor iminor 
syn keyword	cSysFunc		request_irq free_irq
syn keyword	cSysFunc		copy_to_user copy_from_user
syn keyword	cSysFunc		access_ok
syn keyword	cSysFunc		__put_user __get_user
syn keyword	cSysFunc		put_user get_user
syn keyword	cSysFunc		class_createc class_destroy
syn keyword	cSysFunc		class_device_create class_device_destroy



syn keyword	cSysFunc		udelay

syn keyword	cSysFunc		list_for_each_entry
syn keyword	cSysFunc		list_for_each_entry_safe
syn keyword	cSysFunc		list_add list_del
syn keyword	cSysFunc		queue_work

syn keyword cSysFunc 		inb outb
syn keyword cSysFunc 		ioremap iounmap
syn keyword cSysFunc 		ioread8 ioread16 ioread32 ioread64
syn keyword cSysFunc 		iowrite8 iowrite16 iowrite32 iowrite64

syn keyword cSysFunc 		atomic_t ATOMIC_INIT atomic_inc atomic_dec_and_test

syn keyword cSysFunc 		capable
syn keyword cSysFunc 		down up
syn keyword cSysFunc 		down_interruptible
syn keyword cSysFunc 		spin_lock_init spin_lock_irq spin_unlock_irq
syn keyword cSysFunc 		spin_lock spin_unlock
syn keyword cSysFunc 		spin_lock_irqsave spin_unlock_irqrestore
syn keyword	cSysFunc		schedule schedule_timeout
syn keyword	cSysFunc		cpu_relax
syn keyword	cSysFunc		interruptible_sleep_on
syn keyword	cSysFunc		wake_up_interruptible
syn keyword	cSysFunc		tasklet_schedule
syn keyword	cSysFunc		wait_for_completion
syn keyword	cSysFunc		wait_event_interruptible
syn keyword	cSysFunc		wait_event_interruptible_timeout
syn keyword	cSysFunc		set_current_state
syn keyword	cSysFunc		signal_pending
syn keyword	cSysFunc		init_MUTEX

syn keyword cSysFunc 		preempt_disable	preempt_enable
syn keyword cSysFunc 		typecheck

syn keyword	cSysFunc		do_gettimeofday init_timer add_timer del_timer del_timer_sync time_before time_after

syn keyword	cSysFunc		create_proc_entry create_proc_read_entry remove_proc_entry

syn keyword	cSysFunc		__init __exit
syn keyword	cSysFunc		module_param module_init module_exit
syn keyword	cSysFunc		EXPORT_SYMBOL MODULE_AUTHOR MODULE_DESCRIPTION MODULE_LICENSE MODULE_VERSION MODULE_INFO MODULE_ALIAS 
syn keyword	cSysFunc		MODULE_DEVICE_TABLE MODULE_GENERIC_TABLE MODULE_FIRMWARE MODULE_NAME_LEN MODULE_FIRMWARE MODULE_ARCH_INIT

syn keyword	cSysFunc		WARN WARN_ON
syn keyword	cSysFunc		BUG_ON BUG

syn keyword	cSysFunc		S_ISLNK S_ISREG S_ISDIR S_ISCHR S_ISBLK S_ISFIFO S_ISSOCK 


syn keyword cConstant 		GFP_KERNEL GFP_DMA GFP_ATOMIC
syn keyword cConstant 		KERN_EMERG KERN_ALERT KERN_CRIT KERN_ERR KERN_WARNING KERN_NOTICE KERN_INFO KERN_DEBUG KERN_DEFAULT
syn keyword cConstant 		MODULE_STATE_LIVE MODULE_STATE_COMING MODULE_STATE_GOING MODULE_STATE_UNFORMED
